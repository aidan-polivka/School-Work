...
///////////////////////////////////////////////////////////////////////////////
// Implementations for DeJong01 functions
///////////////////////////////////////////////////////////////////////////////

///////////////////////////////////////////////////////////////////////////////
// Constructor
///////////////////////////////////////////////////////////////////////////////
DeJong01::DeJong01(std::mt19937* pRNG) : Problem(3, pRNG)
{
	// genes in the chromosome are in [-5.12, 5.12]
	pGeneDist = new std::uniform_real_distribution<double>(-5.12, 5.12);
	// there are three genes, indexed [0, 1, 2]
	pGeneLocDist = new std::uniform_int_distribution<int>(0, 2);
}
...
///////////////////////////////////////////////////////////////////////////////
double* DeJong01::createChromosome()
{
...
///////////////////////////////////////////////////////////////////////////////
double DeJong01::evaluateChromosome(double* pChrom)
{
	double sum = 0.0;
	for (int i = 0; i < length; i++)
	{
		sum += pChrom[i] * pChrom[i];
	}
...
int main(int argc, char** argv) {
	...
	// Sub ranks method
		...
		// create problem
		Problem* pProblem = new DeJong01(&PRNG);
